const mockState = {
  module: {
    modules: {
      main: [
        { name: "Pokèdex", url: "/" },
        { name: "My Pokèmons", url: "/my-pokemons" },
      ],
      others: [{ name: "Pokèmon Details", url: "/details/:name" }],
    },
  },
  pokemons: {
    pokedex: [
  ...
  catch: { isCatching: false, catchReady: false },
  myPokemons: {
    myPokemons: [
      { nickname: "Test", name: "ivysaur", url: "https://pokeapi.co/api/v2/pokemon/2/" },
      { nickname: "Herman", name: "charmeleon", url: "https://pokeapi.co/api/v2/pokemon/5/" },
      { nickname: "Bapakcu", name: "pikachu", url: "https://pokeapi.co/api/v2/pokemon/25/" },
      { nickname: "Nagabonar", name: "charizard", url: "https://pokeapi.co/api/v2/pokemon/6/" },
      { nickname: "Babu", name: "bulbasaur", url: "https://pokeapi.co/api/v2/pokemon/1/" },
    ],
  },
